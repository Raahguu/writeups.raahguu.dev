...
![Photo of the Login Page that gives login credentials `bob:s3cur3p@ss`](/assets/images/writeups_images/2025/Australian-Cyber-Security-Games/Week-3/Early-Voting-System-v1/1.png)

We then get a page that displays a poll of all voting results

![Photo of the poll of voting results](/assets/images/writeups_images/2025/Australian-Cyber-Security-Games/Week-3/Early-Voting-System-v1/2.png)
...
![Image of Alice's profile page where we can change here vote](/assets/images/writeups_images/2025/Australian-Cyber-Security-Games/Week-3/Early-Voting-System-v1/3.png)
...
![Image of the poll results after changing everyone to vote for Elira Voss, this results in the flag being displayed](/assets/images/writeups_images/2025/Australian-Cyber-Security-Games/Week-3/Early-Voting-System-v1/4.png)
