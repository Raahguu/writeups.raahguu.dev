...
![A Tree structure that shows the branching paths for what language a server with templating could use](assets/images/writeups_images/2025/PicoCTF/SSTI1/1.png)
