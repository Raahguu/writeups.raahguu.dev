...
![picture of the website showing how we caused the our-values.txt file to be read and loaded onto the page due to the command](/assets/images/writeups_images/2025/DownUnder/Philtered/1.png)
